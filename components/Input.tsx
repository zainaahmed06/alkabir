...
export const Input = React.memo(
  forwardRef<TextInput, InputProps>(
    (
      ...
      const {colors, spacing, radius: themeRadius, fontSizes} = useTheme();
      ...
      const sizeConfig = useMemo(
        ...
        [spacing.sm, fontSizes.sm, fontSizes.xs, fontSizes.md]
      );
      ...
      }, [description, colors.textSecondary, fontSizes.xs]);
      ...
      const clearButtonTextStyle = useMemo(
        ...
        [colors.textTertiary, fontSizes.lg]
      );
